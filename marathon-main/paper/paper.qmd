...
\mbox{logit}(\pi_i) &= \alpha + \beta_1 \times \mbox{gender}_i + \\ \beta_2 \times
\mbox{education}_i \\
...
first_model <-
  readRDS(file = here::here("politics2/marathon-main/models/first_model.rds"))
```
